...
//             }
//             else{
//                 DBConnection.createSeries(entry.getSeriesName(),entry.getPublisher(), entry.getXmen(), "SeriesCollection");
...
//                 DBConnection.addIssue(issueName,seriesName,entry.getXmenAdj(),date.toDateTimeString(), "CollectedIssues");
//             }
//             else{
